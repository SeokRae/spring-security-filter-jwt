[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=spring-org_spring-security-filter-jwt&metric=bugs)](https://sonarcloud.io/dashboard?id=spring-org_spring-security-filter-jwt)
